...
#         ci = model_dict["C{:}".format(i+1)](model_dict["S{:}".format(i+1)](model_dict["E{:}".format(i+1)](data_list[i], adj_list[i])))
        ci = model_dict["E{:}".format(i+1)](data_list[i], adj_list[i])
...
#             ci_list.append(model_dict["C{:}".format(i+1)](model_dict["S{:}".format(i+1)](model_dict["E{:}".format(i+1)](data_list[i], adj_list[i]))))
            ci_list.append(model_dict["E{:}".format(i+1)](data_list[i], adj_list[i]))
...
def train_test(data_folder, view_list, num_class,
    ...
    #     adj_parameter = 10
    #     dim_he_list = [400,400,200]    
    if data_folder.startswith('KIPAN/processed/'):
        adj_parameter = 10
        dim_he_list = [400,400,200]
    if data_folder.startswith('GBMLGG/processed/'):
        adj_parameter = 10
        dim_he_list = [400,400,200] 
    if data_folder.startswith('BMD/processed/'):
        adj_parameter = 10
        dim_he_list = [400,400,200]
